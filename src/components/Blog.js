...
const Blog = () => {
  return (
    <article className="body-copy">
      ...
      <p>
        In my experience having rolled back from a previous cohort, the environment is supportive, and really focused on achievement and integrity.
      </p>
      <h4>How do you see yourself engaging with this type of culture?</h4>
      <p>
        I want to learn as much as I can, and most of all, absorb the material so that it can become intuitive as quickly as possible. Coding for me ought to be like speaking, or playing an instrument (on a good day).
        I like the opportunity to develop my ability to manage time. The "depth vs. width" rabbit hole conundrum is interesting for this reason, I hope this improves my ability to "timebox".
      </p>
      <h4>Have your expectations of EDA changed? If so, how?</h4>
      <p>
        No, they've become more refined - I came to EDA with vague notions of what I thought it might be, and an idea of the framework, but very little knowledge of the content itself. This talk and my experiences in Phase-0 are just filling in the blanks at present.
      </p>
